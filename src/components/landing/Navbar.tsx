    ...
    >
        ...
        <div className="hidden md:flex items-center gap-6">
          ...
          {user ? (
            ...
            <>
              ...
              <Button size="sm" onClick={() => navigate("/register")}>Register Your Dealership</Button>
            </>
          )}
        </div>
      ...
      {mobileOpen && (
        <div className="md:hidden bg-card border-b border-border p-4 space-y-3">
          ...
          {user ? (
            <Button className="w-full" size="sm" onClick={() => { navigate("/dashboard"); setMobileOpen(false); }}>Dashboard</Button>
          ) : (
            <>
              <Button variant="ghost" className="w-full" size="sm" onClick={() => { navigate("/sign-in"); setMobileOpen(false); }}>Sign In</Button>
              <Button className="w-full" size="sm" onClick={() => { navigate("/register"); setMobileOpen(false); }}>Register Your Dealership</Button>
            </>
          )}
        </div>
      )}
