      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-6 rounded-lg border bg-muted/30 p-4">
          <p className="text-sm text-muted-foreground">
            <span className="font-semibold text-foreground">Note:</span> The <span className="font-semibold">Top Up Warranty</span> is an add-on to existing manufacturer powertrain warranty coverage — it is not sold as a standalone plan. Click any plan header to view full details.
          </p>
        </div>
      </div>
    </div>
