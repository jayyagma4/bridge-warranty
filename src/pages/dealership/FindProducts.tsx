  ...
  return (
    <DashboardLayout navItems={dealershipNavItems} title="Find Products">
      <div className="-m-6">
              ...
              <div className="flex flex-wrap gap-3 mt-6 bg-white/0">
                ...
                <Button asChild size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10">
                  <Link to="/dealership/compare">
                    <BarChart3 className="mr-1.5 h-4 w-4" /> Compare All Plans
                  </Link>
                </Button>
                <Button asChild size="lg" variant="outline" className="border-white/20 text-white hover:bg-white/10">
                  <Link to="/purchase">
                    <ShoppingCart className="mr-1.5 h-4 w-4" /> New Quote
                  </Link>
                </Button>
              </div>
            </div>
        ...
        {/* Tire & Rim Section — brochure style */}
